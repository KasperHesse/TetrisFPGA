...
##VGA Connector
set_property PACKAGE_PIN G19 [get_ports {io_red[0]}]
set_property PACKAGE_PIN H19 [get_ports {io_red[1]}]
set_property PACKAGE_PIN J19 [get_ports {io_red[2]}]
set_property PACKAGE_PIN N19 [get_ports {io_red[3]}]
set_property PACKAGE_PIN N18 [get_ports {io_blue[0]}]
set_property PACKAGE_PIN L18 [get_ports {io_blue[1]}]
set_property PACKAGE_PIN K18 [get_ports {io_blue[2]}]
set_property PACKAGE_PIN J18 [get_ports {io_blue[3]}]
set_property PACKAGE_PIN J17 [get_ports {io_green[0]}]
set_property PACKAGE_PIN H17 [get_ports {io_green[1]}]
set_property PACKAGE_PIN G17 [get_ports {io_green[2]}]
set_property PACKAGE_PIN D17 [get_ports {io_green[3]}]
